namespace Delegates
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Delegate voidParameterLess = Test;
            // Combine tow delegate to execute (Add + operation)
            voidParameterLess = Delegate.Combine(voidParameterLess, () => Console.WriteLine(Line));
            var invocationList = voidParameterLess.GetInvocationList();
            Console.WriteLine(invocationList.Length);
            // Combine tow delegate to execute (Add + operation)
            voidParameterLess = Delegate.Remove(() => Console.WriteLine(), voidParameterLess);
            Console.WriteLine(invocationList.Length);
            // Execute run 
